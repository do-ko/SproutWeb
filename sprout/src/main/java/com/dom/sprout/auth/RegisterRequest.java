...
public class RegisterRequest {
    ...
    @Schema(description = "First name for the new user", example = "sprout")
    @NotBlank(message = "First name must not be empty or contain only whitespaces")
    private String firstname;

    @Schema(description = "Last name for the new user", example = "web")
    @NotBlank(message = "Last name must not be empty or contain only whitespaces")
