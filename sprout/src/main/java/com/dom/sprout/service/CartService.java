...
//            Optional<CartPlants> cartPlant = cartPlantsRepository.findById(new CartItemId(user.getId(), plant.getId(), ItemType.PLANT));
...
//            Optional<CartGrounds> cartGround = cartGroundsRepository.findById(new CartItemId(user.getId(), ground.getId(), ItemType.GROUND));
...
//            Optional<CartPots> cartPot = cartPotsRepository.findById(new CartItemId(user.getId(), pot.getId(), ItemType.POT));
